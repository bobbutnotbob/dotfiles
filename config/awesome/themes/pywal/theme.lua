...
theme.bg_normal     = theme.color00
theme.bg_focus      = theme.color03
theme.bg_urgent     = "#ff0000"
theme.bg_minimize   = "#444444"
theme.bg_systray    = theme.bg_normal

theme.fg_normal     = theme.color08
...
theme.border_focus  = theme.color02
theme.border_marked = theme.color04
...
theme.wallpaper = string.format("%s/bg.jpg", os.getenv("DOTFILES"))
